...
var AppHttpService = /** @class */ (function () {
    function AppHttpService(http, router, toast, modalService) {
        this.http = http;
        this.router = router;
        this.toast = toast;
    ...
    AppHttpService.prototype.setAccessToken = function () {
        ...
        this.header = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({ 'Authorization': 'Bearer ' + this.token, 'Accept': 'application/json' });
    };
    AppHttpService.prototype.builder = function (resource) {
        this.url = _environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].server_url + '/api/v1/admin/' + resource;
        return this;
    };
    ...
    AppHttpService.prototype.view = function (id, url, include) {
        if (include === void 0) { include = ''; }
        var observable = this.http.get(this.url + url + '/' + id + include, { headers: this.header });
        return this.toPromise(observable);
    };
    ...
    AppHttpService.prototype.insert = function (data) {
        var observable = this.http.post(this.url, data, { headers: this.header });
        return this.toPromise(observable);
    };
    ...
    AppHttpService.prototype.deleteImage = function () {
        var observable = this.http.delete(this.url, {
            headers: this.header
        });
        return this.toPromise(observable);
    };
    // Open default modal
    AppHttpService.prototype.open = function (content, config) {
        var _this = this;
        this.modalReference = this.modalService.open(content, config);
    ...
    AppHttpService.prototype.getDismissReason = function (reason) {
    ...
    AppHttpService.prototype.toPromise = function (request) {
        var _this = this;
        //document.querySelector(".ng-star-inserted").style.position = "fixed";
        return request.toPromise()
            ...
            switch (err.status) {
                case 401:
                    ...
                    localStorage.clear();
                    if (_this.modalReference != null) {
                        _this.modalReference.close();
                    }
                    _this.toast.error(message, 'Erro');
                ...
                case 500:
                    _this.toast.error(message, 'Erro');
                    _this.router.navigate(['/pages/error']);
                    break;
                case 422:
                    _this.bodyRequest = JSON.parse(err._body);
                    _this.toast.error(_this.bodyRequest.message, _this.bodyRequest.title);
                    break;
                case 406:
                    _this.bodyRequest = err.error;
                    _this.toast.error(_this.bodyRequest.message, _this.bodyRequest.title);
                    break;
                case 404:
                    break;
    ...
    AppHttpService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"], ngx_toastr__WEBPACK_IMPORTED_MODULE_5__["ToastrService"], _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_6__["NgbModal"]])
    ], AppHttpService);
...
/* harmony import */ var _app_http_service__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./app-http.service */ "./src/app/app-http.service.ts");
...
var AppModule = /** @class */ (function () {
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
            ...
            providers: [_app_http_service__WEBPACK_IMPORTED_MODULE_13__["AppHttpService"],
                {
...
module.exports = "\n<div class=\"logo\">\n    <a href=\"#\" class=\"simple-text logo-mini\">\n      <div class=\"logo-img\">\n          <img src=\"http://drsgroup.com.br/2016/wp-content/themes/drsgroup/assets/images/logo-drs-group.jpg\"/>\n      </div>\n    </a>\n    <a href=\"https://www.creative-tim.com\" class=\"simple-text logo-normal\">\n        Intranet\n    </a>\n</div>\n<div class=\"sidebar-wrapper\">\n    <ul class=\"nav\">\n        <li routerLinkActive=\"active\" *ngFor=\"let menuItem of menuItems\" class=\"{{menuItem.class}} nav-item\">\n            <a [routerLink]=\"[menuItem.path]\">\n                <i class=\"now-ui-icons {{menuItem.icon}}\"></i>\n                <p>{{menuItem.title}}</p>\n            </a>\n        </li>\n    </ul>\n</div>\n"
...
var ROUTES = [
    { path: '/news', title: 'Noticias', icon: 'business_globe', class: '' },
    { path: '/dashboard', title: 'Idéias', icon: 'business_bulb-63', class: '' }
];
...
var environment = {
    production: true,
    server_url: 'https://portal.drsgroup.com.br',
    //server_url: 'http://10.0.0.51',
...
module.exports = __webpack_require__(/*! C:\Users\leiviton.silva\Projects\front-intranet\src\main.ts */"./src/main.ts");
