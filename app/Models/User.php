 ...
 */
class User extends \Stock\Models\Base\User implements Transformable,AuthenticatableContract,
    ...
    CanResetPasswordContract
{
     ...
     */
    protected $fillable = [
        'name', 'email', 'password','role','company_id','img_profile','status','first_login'
    ];
